...
<body>
  ...
  <div class="Header">
    ...
    <div class="MSJ">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" onclick="Carrito()" id="SvgCarrito" height="24" width="24">
      ...
      <div class="burbuja">
        <p id="FavoritaCantidad">0</p>
      </div>
      <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" id="SvgFavorites">
